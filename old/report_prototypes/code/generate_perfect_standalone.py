"""Generate 100% self-contained standalone_report/index.html with full 390 1-minute bars per day.

Includes:
1. Complete 390 1-minute bars for multiple real trading days (2024-08-21, 2024-08-27, 2024-09-03, 2024-09-11, 2025-01-08).
2. Robust 1m/5m/15m resampling in JavaScript with validation.
3. Updated Production Strategy metrics (Time-Stop 120m + SL 1.5% + 4σ Lockout: +53.2% Return, Sharpe 2.67, Max DD 2.75%).
4. Full interactive Plotly charts that render instantly and reliably offline on file:///.
"""
...
def generate_page():
    print("⏳ Loading 2-year Alpaca data...")
    ...
    # Extract 6 representative trading sessions with ALL 390 1-minute bars
    sample_days = [
        ("2024-08-27", "2024-08-27 — Сделка Long (-365$) | Закрыта в 15:55 ET"),
        ("2024-08-21", "2024-08-21 — 2 Сделки (+248$) | Long (+132$) и Short (+115$)"),
        ("2024-08-22", "2024-08-22 — 2 Сделки (+256$) | Идеальный возврат к нулю"),
        ("2024-09-03", "2024-09-03 — Сделка Short (-310$) | Выход по тайм-стопу"),
        ("2024-09-11", "2024-09-11 — Сделка Long (-273$) | Сброс по Стоп-Лоссу 1.5%"),
        ("2025-01-08", "2025-01-08 — Сделка Long (+172$) | Быстрый Тейк-Профит за 43 мин")
    ]
