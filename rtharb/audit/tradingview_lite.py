...
def main() -> None:
    ...
    assert set(payload["variants"]) == {"base", "base_anchor", "hybrid_abs", "hybrid_abs_anchor", "base_inverse", "rr_classic", "vwap_z", "rr_vwap", "rr_vwap_075", "rr_vwap_1", "rr_vwap_15", "rr_vwap_2", "rr_vwap_3", "time_stop_q95", "stop_loss_q95"}
    ...
    for token in ("CandlestickSeries", "createSeriesMarkers", "trade-box", "Z-score", "Equity", "updateEquity", "statMdd", "data-ema", "data-hma", "nvdaVwapToggle", "qqqVwapToggle", "toggleQqq", "toggleAbsFilter", "toggleAnchorFilter", "toggleInverse", "toggleRr", "toggleVwapZ", "toggleVwapRr", "vwapRrRatio", "toggleTimeStop", "toggleStopLoss", "researchNote", "QQQ", "NVDA"):
